...
const PrivacyPolicyPage = () => {
  return (
    <>
      <BreadCrumbs />
      <div className='wrapper privacy-policy__page--wrapper'>
        <div className='content'>
          ...
          <p>
            You can access and use the App and Services without telling us who
            ...
            use some of the features offered on the App, you may be asked to
          ...
          <p>
            The App and Services contain links to other resources that are not
            ...
            third parties. We encourage you to be aware when you leave the App
